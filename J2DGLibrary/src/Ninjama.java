...
public class Ninjama extends Game
{
	...
	public Ninjama(String gameName) throws Exception
	{
		...
		new Hero("Hero", 350, 110); // Création d'un sol de type rigidBody et kinématic
		new Floor("Sol", 100, 200); // Création d'un cube maniable de type rigidBody et non kinématic, déplacable
	}
